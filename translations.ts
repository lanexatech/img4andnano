export const translations = {
  en: {
    ...
    custom_api_key_label: "Custom API Key (Optional)",
    model_label: "Model",
    ...
    api_key_placeholder: "Enter new API key if you hit the limit",
    ...
    save_api_key_aria: "Save API Key",
  ...
  id: {
    ...
    custom_api_key_label: "Kunci API Kustom (Opsional)",
    model_label: "Model",
    ...
    api_key_placeholder: "Masukkan kunci API baru jika Anda mencapai batas",
    ...
    save_api_key_aria: "Simpan Kunci API",
